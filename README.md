...
| **[Claude 技能构建完全指南 (英文原版)](./docs/The%20Complete%20Guide%20to%20Building%20Skills%20for%20Claude.pdf)** | 📕 **Official Guide PDF** - Anthropic 官方出品的 Skill 构建完全指南，涵盖基础概念、规划与设计、测试与迭代、分发与共享、模式与故障排除等完整内容。 |
| **[Claude 技能构建完全指南 (中文版)](./docs/The-Complete-Guide-to-Building-Skill-for-Claude.no_watermark.zh-CN.pdf)** | 📗 **Official Guide PDF (中文)** - 上述指南的中文翻译版本，方便中文开发者阅读。 |
