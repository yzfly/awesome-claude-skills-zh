...
#### 🔬 垂直领域
- [**AuraKit**](https://github.com/smorky850612/Aurakit)  
  全栈 Claude Code 开发工作流框架。**46 种模式**（BUILD/FIX/DEPLOY/REVIEW/TDD/QA/DEBUG/PAYMENT），23 个子代理，6 层 OWASP+ 安全防护，Haiku/Sonnet 分层路由节省 ~55% Token。一条  命令，覆盖完整开发生命周期。
